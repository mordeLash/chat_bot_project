...
class TransformMapConfigurationRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TransformMapConfigurationRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TransformMapConfigurationRequest
    let len;
    let data = new TransformMapConfigurationRequest(null);
  ...
  static datatype() {
    ...
    return 'pal_navigation_msgs/TransformMapConfigurationRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TransformMapConfigurationRequest(null);
...
class TransformMapConfigurationResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TransformMapConfigurationResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TransformMapConfigurationResponse
    let len;
    let data = new TransformMapConfigurationResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TransformMapConfigurationResponse(null);
...
module.exports = {
  Request: TransformMapConfigurationRequest,
  Response: TransformMapConfigurationResponse,
  md5sum() { return '23aa9750afc82f6179dccc19be33142b'; },
  datatype() { return 'pal_navigation_msgs/TransformMapConfiguration'; }
};
